        ...
        <div class="mt-12">
          <div class="text-sm uppercase mb-2">
            {results().length === 1 
              ...
              : `${results().length} résultats trouvés pour `
            }
            {`'${query()}'`}
          </div>
